...
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                <div class="card mt-5">
                    <B class="card-header">LISTE DES APPARTEMENTS DE LA COPROPRIETE ({{$nb}} Appartements)</B>
                    <div class="card-body">
                        <table class="table border">
                            <thead class=" border">
                                <tr>
                                    <th scope="col" class="border col-2">APPARTEMENT NUMERO</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse($Apparts as $appart)
                                <tr class=" border">
                                    <td class="border">{{$appart}}</td>
                                </tr>
                                @empty
